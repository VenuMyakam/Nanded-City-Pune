                ...
                <div class="col-md-3 col-xs-6 col-sm-4 gallery-grid">
                        <div class="grid">
                            <figure class="effect-apollo effect-apollo2"><a class="example-image-link"
                                    href="https://nandedcitypune.com/independence-day-celebrations-2023/" data-title="Republi Day Celebrations">
                                    <img src="https://nandedcitypune.com/wp-content/uploads/2023/08/independence-day-2023-cover.jpg"
                                        title="Independence Day Celebrations" alt="Independence Day Celebrations" />
                                </a>
                                <figcaption class="gr-head">
                                    <a href="https://nandedcitypune.com/independence-day-celebrations-2023/"
                                        data-title="Independence Day Celebrations">Independence Day <br>Celebrations - 2023</a>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
                            ...
                            <figure class="effect-apollo effect-apollo2"><a class="example-image-link"
                                ...
                                <figcaption class="gr-head">
                                    <a href="https://nandedcitypune.com/republi-day-celebrations-2023/"
                                        data-title="Republic Day Celebrations">Republic Day <br>Celebrations - 2023</a>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
                            ...
                            <figure class="effect-apollo effect-apollo2"><a class="example-image-link"
                                ...
                                <figcaption class="gr-head">
                                    <a href="https://nandedcitypune.com/deepotsav-celebrations-2022/"
                                        data-title="Deepotsav">Deepotsav <br>Celebrations - 2022</a>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
                            ...
                            <figure class="effect-apollo effect-apollo2"><a class="example-image-link"
                                ...
                                <figcaption class="gr-head">
                                    <a href="https://nandedcitypune.com/dandiya-celebrations-2022/"
                                        data-title="Dandiya">Dandiya <br>Celebrations - 2022</a>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
                            ...
                            <figure class="effect-apollo effect-apollo2"><a class="example-image-link"
                                ...
                                <figcaption class="gr-head">
                                    <a href=" https://nandedcitypune.com/ganesh-festival-2022/"
                                        data-title="Ganesh Festival Celebrations">Ganesh Festival <br>Celebrations - 2022</a>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-4 gallery-grid">
                        <div class="grid">
                            <figure class="effect-apollo effect-apollo2"><a class="example-image-link"
                                ...
                                <figcaption class="gr-head">
                                    <a href="?page_id=1410" data-title="We Care Kit Distribution">Pulse polio - 2022</a>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
