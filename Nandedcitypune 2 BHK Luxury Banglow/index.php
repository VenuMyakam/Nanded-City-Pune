...
<title>Kalashree - Bageshree</title>
...
<!-- Global site tag (gtag.js) - Google Ads: 825412409 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-825412409"></script>
<script>
window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', 'AW-825412409');
</script>
<!-- Event snippet for Submit lead form conversion page -->
<script>
gtag('event', 'conversion', {'send_to': 'AW-825412409/T6FYCMrOnskCELmWy4kD'});
</script>
...
fbq('init', '1601218736739842');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1601218736739842&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->
<!-- Taboola Pixel Code -->
<script type='text/javascript'>
  window._tfa = window._tfa || [];
  window._tfa.push({notify: 'event', name: 'page_view', id: 1333147});
  !function (t, f, a, x) {
  ...
  '//cdn.taboola.com/libtrc/unip/1333147/tfa.js',
  'tb_tfa_script');
</script>
...
.en-bs-avail{right: 19px !important;top:92px !important;}
.en-ks-avail{right:19px;top:92px !important;}
 }
   @media only screen and (min-width:360px) and (max-width:375px){
.en-bs-avail{right:30px !important;top:110px !important;}
.en-ks-avail{right:30px; top: 110px !important;}
 }
 @media only screen and (min-width:379px) and (max-width: 411px){
.en-bs-avail{right: 36px !important;top:115px !important;}
.en-ks-avail{right: 35px;top:115px !important;}
 }
/*   @media only screen and (min-width: 412px) and (max-width: 430px){
  .en-bs-avail{right:43px !important;top:120px !important;}
  }*/
@media only screen and (min-width: 412px) and (max-width: 430px){
  .en-bs-avail{right:43px !important;top:120px !important;}
  .en-ks-avail{right:40px !important;top:124px !important;}
  }
  @media only screen and (min-width:480px) and (max-width:530px){
  .en-bs-avail{right:55px !important;top:140px !important;}
  .en-ks-avail{right:38px !important;top:140px !important;}
  }
    @media only screen and (min-width:530px) and (max-width:620px){
  .en-bs-avail{right:62px !important;top:155px !important;}
  .en-ks-avail{right:62px !important;top:155px !important;}
  }
      @media only screen and (min-width:768px) and (max-width:810px){
  .en-bs-avail{right:110px !important;top:228px !important;}
  .en-ks-avail{right:110px !important;top:228px !important;}
  }
  @media only screen and (min-width: 1024px) and (max-width: 1199px){
  .en-bs-avail {position: absolute;right: 11% !important;top:330px !important;}
.en-ks-avail{right: 11% !important;top:330px !important;}
.en-wi{width: auto;}
}
@media only screen and (min-width: 1820px) and (max-width: 1920px){
.en-avail{top: 76% !important;left: 0;right: 0;display: inline-grid;}
.en-bs-avail{top: 590px !important;right: 316px !important;}
.en-ks-avail{top: 590px !important;right: 316px !important;}
}
@media only screen and (min-width: 1199px) and (max-width: 1280px){
.en-avail{top: 73% !important;left: 0;right: 0;display: inline-grid;}
.en-bs-avail{top: 403px !important;right: 175px !important;}
.en-ks-avail{top: 410px !important;right: 175px !important;}
}
@media only screen and (min-width: 1380px) and (max-width: 1440px){
.en-avail{top: 73% !important;left: 0;right: 0;display: inline-grid;}
.en-bs-avail{top: 450px !important;right: 210px !important;}
.en-ks-avail{top: 460px !important;right: 210px !important;}
}
@media only screen and (min-width: 1520px) and (max-width: 1600px){
.en-avail{top: 73% !important;left: 0;right: 0;display: inline-grid;}
.en-bs-avail{top: 500px !important;right: 242px !important;}
.en-ks-avail{top: 510px !important;right: 232px !important;}
}
 </style>
</head>
...
<div class="logo"><a href="https://nandedcitypune.com/" ><img src="images/logo_1.png" alt=""></a>
...
<li><a href="#ab-nan">PROJECT STATUS</a></li>
<li><a href="#contact">contact us</a></li>
<li class="enbtn"><button data-modal-trigger="trigger-1" class="trigger"><a href="#">Enquire Now</a> </button></li>
</ul>
</nav>
...
<div class="header_wrap d-flex flex-row align-items-center justify-content-center">
<div class="logo"><a href="https://nandedcitypune.com"><img src="images/logo_1.png" alt=""></a></div>
...
<li><a href="#ab-nan">PROJECT STATUS</a></li>
<li><a href="#contact">contact us</a></li>
<li class="enbtn2" ><button data-modal-trigger="trigger-1" class="trigger"><a href="#">Enquire Now</a> </button></li>
</ul>
</nav>
...
<!-- <div>
    <img src="images/tomorrow-21yrs.jpg" class="img-responsive" alt="Clap for yourself">
    <div class="en-avail">
<button data-modal-trigger="trigger-1" class="trigger">
<a href="#" class="btn">
<img src="images/enq-btn-new.png" /></a>
</button>
</div> -->
...
<div>
<img src="images/kb-festive-2022.jpg" class="img-responsive" alt="Clap for yourself">
<div class="en-avail">
<button data-modal-trigger="trigger-1" class="trigger">
<a href="#" class="btn">
<img src="images/enq-btn-new.png" /></a>
...
<div>
<img src="images/new-neighbourhoods-pune.jpg" class="img-responsive" alt="Clap for yourself">
<div class="en-avail">
<button data-modal-trigger="trigger-1" class="trigger">
<a href="#" class="btn">
<img src="images/enq-btn-new.png" /></a>
...
<div>
<img src="images/new-launch-ban2.jpg"  class="img-responsive" alt="Clap for yourfamily">
<div class="en-bs-avail">
<button data-modal-trigger="trigger-1" class="trigger">
<a href="#" class="btn">
<img src="images/enq-btn-new.png" /></a>
</button>
...
<div>
<img src="images/new-launch-ban3.jpg"  class="img-responsive" alt="Bageshree-Kalashree launching two new Neighbourhoods">
<div class="en-ks-avail">
<button data-modal-trigger="trigger-1" class="trigger">
<a href="#" class="btn">
<img src="images/enq-btn-new.png" /></a>
</button>
...
<div class="th_btn">
<a href="https://nandedcitypune.com/Bageshree_Kalashree_Brochure.pdf" target="_blank">
...
<div class="sample-ft" id="">
<div class="container">
<div class="row revealIn">
<div class="text-center col-12 revealIn">
<h2>Sample Furnished Flat fdvuhfdvufd</h2>
</div>
<div class="col-sm-12 col-md-12 col-lg-10 col-12 flat-br text-center offset-lg-1">
<div class="flat-bg">
<div class="flat-logo">
<img src="images/bs-logo-flat.png">
</div>
<div class="row no-pad">
<div class="col-lg-6 col-sm-6 col-xs-12 no-pad flat-ml fl-wi-lf">
<div class="col-lg-12 no-pad">
<div class="img-wrapp">
<a href="images/master-bed-room-big.jpg" class="img-innerc">
<img src="images/master-bed-room-small.jpg"/>
<div class="flat-tl img-content">
...
<div class="row fl-mr">
<div class="col-lg-6 pl-pb flat-pl-pr">
<div class="img-wrapp">
<a href="images/kitchen-big.jpg" class="img-innerc">
<img src="images/kitchen-small.jpg" />
<div class="flat-tl img-content">
<h4>Kitechen</h4>
<h2><span><i class="fa fa-search-plus" aria-hidden="true"></i></span></h2>
</div></a>
...
<div class="col-lg-6 pl-pb flat-pr-pl">
<div class="img-wrapp">
<a href="images/bedroom-big.jpg" class="img-innerc">
<img src="images/bed-room-small.jpg" />
<div class="flat-tl img-content">
<h4>Bedroom</h4>
<h2><span><i class="fa fa-search-plus" aria-hidden="true"></i></span></h2>
</div></a>
...
<div class="col-lg-6 fl-wi-rf">
<div class="row fl-mr">
<div class="col-lg-6 rl-pl-pr">
<div class="img-wrapp">
<a href="images/livin-room-big.jpg" class="img-innerc">
<img src="images/livin-room-small.jpg" />
<div class="flat-tl img-content">
<h4>Living Room</h4>
<h2><span><i class="fa fa-search-plus" aria-hidden="true"></i></span></h2>
</div></a>
...
<div class="col-lg-6 rl-pr-pl">
<div class="img-wrapp">
<a href="images/terrace-big.jpg" class="img-innerc">
<img src="images/terrace-small.jpg" />
<div class="flat-tl img-content">
<h4>Terrace</h4>
<h2><span><i class="fa fa-search-plus" aria-hidden="true"></i></span></h2>
</div></a>
...
<div class="col-lg-12 no-pad">
<div class="img-wrapp">
<a href="images/dinnin-area-big.jpg" class="img-innerc">
<img src="images/dinnin-area-small.jpg"/>
<div class="flat-tl img-content">
<h4>Dining Area</h4>
<h2><span><i class="fa fa-search-plus" aria-hidden="true"></i></span></h2>
</div></a>
...
<div class="fl-content text-left">
<p><sup>*</sup>Disclaimer:</p>
<p>The pictures of the proposed Residential Flat/Unit and all furniture's, fixtures, items, electronic goods, amenities, landscaping, accessories etc. specified therein are only for the purpose of showcasing the Residential Flat/Unit and the Developer is not liable / required to provide any furniture, items, electronic goods amenities, accessories etc. as displayed in the picture.</p>
</div>
</div>
</div>
...
<div class="row">
<div class="col-md-12">
<center><iframe width="100%" height="590px" src="https://www.youtube.com/embed/wF9Dct2xHC0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></center>
</div>
</div>
</div>
...
<div class="th_btn">
<button data-modal-trigger="trigger-1" class="trigger"><a href="#">Enquire Now</a> </button>
</div>
</div>
...
<div class="map-point-sm active" data-show=".darwin">
...
<div class="container-fluid no-pad">
  ...
  <div class="col-lg-12 col-12 col-sm-12 col-md-12 no-pad">
    <div class="section_title text-center">
      <h2>master layout</h2>
    </div>
  <div class="zoom-image">
<img class="product-photo" data-original-image="images/master-layout-new.gif" src="images/master-layout-new.gif" />
...
<section class="ksbs-construct" id="ab-nan">
  <div class="container">
    <div class="row">
...
<h2>PROJECT STATUS</h2>
      ...
      <div class="col-md-6 col-sm-6">
       <h3>Kalashree</h3>
       <div class="ks-constructimg">
        <div class="owl-carousel">
        <div class="slides"><img src="images/ks-1.jpg" alt="img1" /><div class="ksbs-title"><b>Main entrance</b><span class="pull-right">1/6</span></div></div>
        <div class="slides"><img src="images/ks-2.jpg" alt="img1" /><div class="ksbs-title"><b>Tower A </b><span class="pull-right">2/6</span></div></div>
        <div class="slides"><img src="images/ks-3.jpg" alt="img1" /><div class="ksbs-title"><b>Tower B</b><span class="pull-right">3/6</span></div></div>
        <div class="slides"><img src="images/ks-4.jpg" alt="img1" /><div class="ksbs-title"><b>Tower C</b><span class="pull-right">4/6</span></div></div>
        <div class="slides"><img src="images/ks-5.jpg" alt="img1" /><div class="ksbs-title"><b>Tower D </b><span class="pull-right">5/6</span></div></div>
        <div class="slides"><img src="images/ks-6.jpg" alt="img1" /><div class="ksbs-title"><b>Tower E </b><span class="pull-right">6/6</span></div></div>
        </div>
        <!-- <div id="counter"></div>  -->
      </div>
      </div>
      ...
      <div class="col-md-6 col-sm-6">
        <h3>Bageshree</h3>
        <div class="bs-constructimg">
        <div class="owl-carousel">
        <div class="slides"><img src="images/bs-3.jpg" alt="img1" /><div class="ksbs-title"><b>Main entrance </b><span class="pull-right">1/6</span></div></div>
        <div class="slides"><img src="images/bs-4.jpg" alt="img1" /><div class="ksbs-title"><b>Tower A </b><span class="pull-right">2/6</span></div></div>
        <div class="slides"><img src="images/bs-5.jpg" alt="img1" /><div class="ksbs-title"><b>Tower B </b><span class="pull-right">3/6</span></div></div>
        <div class="slides"><img src="images/bs-6.jpg" alt="img1" /><div class="ksbs-title"><b>Tower C </b><span class="pull-right">4/6</span></div></div>
        <div class="slides"><img src="images/bs-7.jpg" alt="img1" /><div class="ksbs-title"><b>Tower D </b><span class="pull-right">5/6</span></div></div>
        <div class="slides"><img src="images/bs-8.jpg" alt="img1" /><div class="ksbs-title"><b>Tower E </b><span class="pull-right">6/6</span></div></div>
        </div>
        <!-- <div id="counter"></div>  -->
        </div>
      </div>
        ...
        <div class="row contact-info revealIn">
          ...
          <div class="col-lg-5 col-md-5 col-sm-5 col-12">
            ...
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <address>Nanded, Sinhagad Road, <br>Pune, India.</address>
            </div>
            ...
            <div class="contact-phone">
             <i class="fa fa-phone" aria-hidden="true"></i>
              ...
              <div style="margin-bottom: 2px;"></div>
               ...
               <p><b>1800 267 3002</b></p>
			    <div style="margin-bottom: 2px;"></div>
               <h4>Contact Us </h4> 
               <p><b>705800 23373</b></p>
            </div>
...
<li class="list-inline-item"><a href="#"><i class="fa fa-youtube" aria-hidden="true"></i></a></li>
        ...
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30275.991604824383!2d73.7766644260545!3d18.46104519638273!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc29598ebf615a3%3A0x63c4129af9a373da!2sNanded%2C%20Pune%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1582208295931!5m2!1sen!2sin" width="100%" height="400" frameborder="0" scrolling="no"></iframe>
        </div>
...
<div data-modal="trigger-1" class="modal-av">
  <article class="content-wrapper">
    ...
    <form id="enquirymain" name="enquirymain"   method="POST">
...
<div id='enqresults' style="/* display: none; */color: #264e0b;font-weight: bold;"></div>
...
<div class="modal-header">
<button type="button" class="reg-cls" data-dismiss="modal">X</button>
<h4 class="modal-title tl">Enquiry Nowsd</h4>
</div>
<div class="modal-body">
<div id="download">
<form id="enquirymaindd" name="enquirymaindd"   method="POST">
<div class="form-group">
<input type="text" name="name" placeholder="Name" class="form-control field">
<i class="fa fa-pencil" aria-hidden="true"></i>
</div>
...
<!-- Modal HTML -->
    ...
    <!--            </div>-->
    <!--            <div class="modal-body">-->
    <!--                <img src="https://nandedcitypune.com/wp-content/uploads/2022/08/75_on_75-scaled.jpg" class="img-fluid" >-->
    <!--                <iframe id="cartoonVideo" width="100%" height="315" src="//www.youtube.com/embed/TMgOAVePlD8?autoplay=1" frameborder="0" allowfullscreen></iframe>-->
    <!--            </div>-->
    <!--        </div>-->
    <!--    </div>-->
    <!--</div>-->
...
$(document).ready(function(){
  ...
  $(document).ready(function(){
    $("#aoffers").validate({
      ...
      submitHandler: function(form) {
        // do other stuff for a valid form
        $.post('https://nandedcitypune.com/kalashree-bageshree/offers.php', $("#aoffers").serialize(), function(data) {
 ...
 <script type="text/javascript">
  ...
  $(document).ready(function(){
    $("#enquirymain").validate({
      ...
      submitHandler: function(form) {
        // do other stuff for a valid form
        $.post('https://nandedcitypune.com/kalashree-bageshree/enquiry.php', $("#enquirymain").serialize(), function(data) {
  ...
  $(document).ready(function(){
    $("#enquirysub").validate({
      ...
      submitHandler: function(form) {
        // do other stuff for a valid form
        $.post('https://nandedcitypune.com/kalashree-bageshree/enquiry.php', $("#enquirysub").serialize(), function(data) {
  ...
  $(document).ready(function(){
    $("#downloads").validate({
      ...
      submitHandler: function(form) {
        // do other stuff for a valid form
        $.post('https://nandedcitypune.com/kalashree-bageshree/downloads.php', $("#downloads").serialize(), function(data) {
		  ...
		  $('#popupboost').hide();
		  //window.open('https://nandedcitypune.info/Bageshree_Kalashree_Brochure.pdf');
		 // $('#down-modal').modal('show')
		  
		  var open = window.open('https://nandedcitypune.com/kalashree-bageshree/Bageshree_Kalashree_Brochure.pdf');
if (open == null || typeof(open)=='undefined')
  ...
  $(document).ready(function(){
    $("#unitplans").validate({
      ...
      submitHandler: function(form) {
        // do other stuff for a valid form
        $.post('https://nandedcitypune.com/kalashree-bageshree/unitplans.php', $("#unitplans").serialize(), function(data) {
...
jQuery(window).on('load', function() {
    jQuery('#myVideoModal').modal('show');
});
