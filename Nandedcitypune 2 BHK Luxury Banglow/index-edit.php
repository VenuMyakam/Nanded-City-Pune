...
.en-bs-avail{right: 19px !important;top:70%;}
.en-ks-avail{right:19px;}
 }
   @media only screen and (min-width:360px) and (max-width:375px){
.en-bs-avail{right:32px !important;top:70%;}
.en-ks-avail{right:28px;}
 }
 @media only screen and (min-width:379px) and (max-width: 411px){
.en-bs-avail{right: 34px !important;top:70%;}
.en-ks-avail{right: 32px;}
 }
   @media only screen and (min-width: 412px) and (max-width: 430px){
 }
  .en-bs-avail{right: 39px;top:70%;}
  }
@media only screen and (min-width: 412px) and (max-width: 430px){
  .en-bs-avail{right:38px;top:70%;}
  }
  @media only screen and (min-width:480px) and (max-width:530px){
  .en-bs-avail{right:50px;top:70%;}
  }
    @media only screen and (min-width:530px) and (max-width:620px){
  .en-bs-avail{right:62px;top:70%;}
  }
      @media only screen and (min-width:768px) and (max-width:810px){
  .en-bs-avail{right:115px !important;top:70%;}
  }
...
<!-- START MOD -->
 <div class="slick-carousel" id="home">
    <div>
    <img src="images/slide1.png" class="img-responsive" alt="Clap for yourself">
    <div class="en-avail">
...
<!-- <h1>2 New Neighbourhoods.<br>Infinite Possibilities.</h1> 
 --></div>
    ...
    <div>
   	<img src="images/slide2-new.png"  class="img-responsive" alt="Clap for yourfamily">
...
<!-- <h1>Homes designed for you.<br> A lifestyle common to none.</h1> 
 --></div> 
  ...
  <!--  <div>
   ...
   <div>
    <img src="images/slide3-new.png"  class="img-responsive" alt="Bageshree-Kalashree launching two new Neighbourhoods">
